...
static const ScriptSystemFunctionInfo ourFunctionList[] = {
	...
	{ "File::ReadInt^0", (ScriptAPIFunction *)&Script_File_ReadInt, "", sotNone },
	{ "File::ReadRawChar^0", (ScriptAPIFunction *)&Script_File_ReadRawChar, "", sotNone },
	{ "File::ReadRawInt^0", (ScriptAPIFunction *)&Script_File_ReadRawInt, "", sotNone },
	{ "File::ReadRawLine^1", (ScriptAPIFunction *)&Script_File_ReadRawLine, "s", sotNone },
	{ "File::ReadString^1", (ScriptAPIFunction *)&Script_File_ReadString, "s", sotNone },
	{ "File::ReadRawLineBack^0", (ScriptAPIFunction *)&Script_File_ReadRawLineBack, "", sotNone },
	{ "File::ReadStringBack^0", (ScriptAPIFunction *)&Script_File_ReadStringBack, "", sotNone },
	{ "File::WriteInt^1", (ScriptAPIFunction *)&Script_File_WriteInt, "i", sotNone },
	{ "File::WriteRawChar^1", (ScriptAPIFunction *)&Script_File_WriteRawChar, "i", sotNone },
	{ "File::WriteRawLine^1", (ScriptAPIFunction *)&Script_File_WriteRawLine, "s", sotNone },
	{ "File::WriteString^1", (ScriptAPIFunction *)&Script_File_WriteString, "s", sotNone },
	{ "File::get_EOF", (ScriptAPIFunction *)&Script_File_get_EOF, "", sotNone },
	{ "File::get_Error", (ScriptAPIFunction *)&Script_File_get_Error, "", sotNone },
};
