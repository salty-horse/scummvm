...
void addGraphicsSystemScripting(GlobalScriptState *state) {
	...
	state->addSystemFunctionImport("SetNextScreenTransition", &Script_UnimplementedStub);
	state->addSystemFunctionImport("SetScreenTransition", &Script_UnimplementedStub);
